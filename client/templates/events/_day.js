...
_dayHelpers = {
    ...
    //events:function(){
    //    return Events.find({date: formatDate.toIsoFrom3args(getYear(),getMonth(),this.day)},{sort:{begin:1}});
    //},
    eventsCount: function () {
        ...
        if (types) {
            return Events.find({
                date: formatDate.toIsoFrom3args(getYear(this), getMonthReal(this), this.getDate()),
                type: {$in: types}
            }).count();
        } else return Events.find({date: formatDate.toIsoFrom3args(getYear(this), getMonthReal(this), this.getDate())}).count();
    },
    todayClass: function () {
